...
This command automatically provides Islamic responses when you use Islamic phrases.
...
The bot will respond automatically to these phrases!`;
    ...
    onChat: async function ({ api, event }) {
        ...
        const islamicReplies = {
            ...
            'hello muslim': '👋 Assalamualaikum dear brother/sister! 🤲',
            ...
            // Islamic Knowledge
            'what is islam': '🕌 Islam means "submission to the will of Allah." It is a complete way of life based on Quran and Sunnah!',
            'who is allah': '🤲 Allah is the One True God, Creator of everything. He has 99 beautiful names describing His perfection!',
            'who is prophet muhammad': '🌹 Prophet Muhammad (PBUH) is the final messenger of Allah, sent as mercy to all worlds!',
            'five pillars': '🏛️ 1. Shahadah (Faith)\n2. Salah (Prayer)\n3. Zakah (Charity)\n4. Sawm (Fasting)\n5. Hajj (Pilgrimage)'
        };
